...
if (!ADMIN_API_KEY) {
  console.error(
    "[LỖI NGHIÊM TRỌNG] ADMIN_API_KEY chưa được thiết lập trong file .env. Server sẽ không khởi động."
  );
  process.exit(1);
}
...
// --- 4. LẬP LỊCH TỰ ĐỘNG (CRON JOB) MỖI 12H ---
cron.schedule(
  "0 0,12 * * *",
  () => {
...
// --- 5. API ENDPOINTS ---
/**
 * API CHO NGƯỜI DÙNG: Lấy điểm an toàn đã tính toán kèm nhận xét AI
 */
